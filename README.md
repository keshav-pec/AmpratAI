...
**Seven stages, all written** — 215 topics, from Python for AI code and FastAPI, through LLM
APIs, RAG and evals, agents and MCP, and AI system design and operations, to the capstone,
the portfolio, interviews and negotiation. The home page opens on a summary of where you are
and what's next.
...
- **Practice** — six kinds: hand-write a primitive, read code and predict, spec it then
  review what AI wrote, use a real tool, decide and defend, or break it on purpose. You do
  these in your own editor, then open the answer to check yourself — all 511 practice items
  have one.
...
and watch what changes. There are 57 of them across the seven stages.
...
content/
  ...
  topics/             all seven stages — 215 topics
  animations/         57 animation specs, one file per stage
